...
func main() {
	...
	i16, _ := strconv.ParseInt(os.Args[2], 10, 16)
	fmt.Println("int16 value is:", int16(i16))
	// 2. Get an int32 value using ParseInt and convert it and print it
	i32, _ := strconv.ParseInt(os.Args[3], 10, 32)
	fmt.Println("int32 value is:", int32(i32))
	// 3. Get an int64 value using ParseInt and convert it and print it
	i64, _ := strconv.ParseInt(os.Args[4], 10, 64)
	fmt.Println("int64 value is:", int64(i64))
	// 4. Get an int8 value using ParseInt and convert it and print it
	//    But this time, get the value in bits.
	b, _ := strconv.ParseInt(os.Args[5], 2, 8)
	fmt.Printf("%s is %d \n", os.Args[5], int8(b))
